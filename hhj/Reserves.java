...
public class Reserves extends JPanel {
	...
	//	buton=new JPanel[1];//모두 크기 6의 배열 생성
		...
		//	buton[i]= new JPanel(new GridLayout(1,3));
			switch(i) {
			case 0:
				item[i] = new Reserve1Image("src\\hhj\\01.jpg"); break;
			case 1:
				item[i] = new Reserve1Image("src\\hhj\\02.jpg"); break;
			case 2:
				item[i] = new Reserve1Image("src\\hhj\\03.jpg"); break;
			case 3:
				item[i] = new Reserve1Image("src\\hhj\\04.jpg"); break;
			case 4:
				item[i] = new Reserve1Image("src\\hhj\\05.jpg"); break;
			case 5:
				item[i] = new Reserve1Image("src\\hhj\\06.jpg"); break;
			}
		...
		home.addActionListener(new MyButtonListener5(this));
		prev = new JButton("이전");
		prev.addActionListener(new MyButtonListener5(this));
		next = new JButton("다음");
		next.addActionListener(new MyButtonListener5(this));
...
class Reserve1End extends WindowAdapter{		//어댑터로 이벤트처리//////////////////
...
class Reserve1Exit implements WindowListener{
	@Override
...
class Reserve1Image extends JPanel{
	Image img;
	Reserve1Image(String path){		//path = 경로를 받기 위해
