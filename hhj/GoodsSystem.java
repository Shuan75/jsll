...
public class GoodsSystem extends JFrame {
   JPanel[] panel;
   JPanel[] panels;
   JPanel[] Imagepanel;
//   JPanel[] imagepanel;
...
//      Imagepanel[0].add(image[0]);
   ...
   void makeImagepanel() { //이미지담을이미지패널
      ...
      Imagepanel[0] = new goodsImage("src\\hhj\\2-1.jpg"); //이미지담기
      Imagepanel[1] = new goodsImage("src\\hhj\\2-2.jpg");
      Imagepanel[2] = new goodsImage("src\\hhj\\2-3.jpg");
      Imagepanel[3] = new goodsImage("src\\hhj\\2-4.jpg");
      Imagepanel[4] = new goodsImage("src\\LHJ\\2-5.jpg");
      Imagepanel[5] = new goodsImage("src\\LHJ\\2-6.jpg");
   ...
   public GoodsSystem(String str){//생성자
      super(str);
