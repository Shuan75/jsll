...
public class SearchTicket extends JPanel implements ActionListener {
	
	
	@Override
	public void actionPerformed(ActionEvent e) {
         
		if(e.getSource() == buttons[0]) { //검색버튼누른경우
	
		}else if(e.getSource() == buttons[1]) { //취소버튼누른경우
